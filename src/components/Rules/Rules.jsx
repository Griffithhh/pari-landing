  ...
  return (
      <div className="rules">
          <div className='navbar'>
              <div className='logo'>
                  <p>RULES ARE EASIER THAN EVER</p>
              </div>
          </div>
          <div className="rules_container">
              ...
              <div className="wrapper_2">
                  ...
                  <div className="rules_info">
                      ...
                      <div className="text_rules">
                          <p className='p_txt'>Place bets on <br></br> <span className='span_txt'>The Cricket <br></br> World Cup <br></br> Tournament</span>
                              <br></br> <p style={{fontSize: 12}}>You can start with <br></br> a minimum of ₹750</p></p>
                      </div>
                  </div>
              </div>
              <div className="line_between"></div>
              <div className="wrapper_3">
                  ...
                  <div className="rules_info">
                      ...
                      <div className="text_rules" id='text_rules_3'><p className='p_txt' style={{fontSize: 12}}>Be among
                          the
                          first <br></br> 1,000 on the
